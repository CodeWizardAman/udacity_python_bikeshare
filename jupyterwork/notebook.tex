...
\textbf{Answer}: What is the average number of bookings per hour in a
day? How many people took ride on weekends?
...
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{first\PYZus{}trip} \PY{o}{=} \PY{n}{trip\PYZus{}reader}\PY{o}{.}\PY{n+nf+fm}{\PYZus{}\PYZus{}next\PYZus{}\PYZus{}}\PY{p}{(}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{n}{first\PYZus{}trip}\PY{p}{)}
...
City: Chicago
OrderedDict([('trip\_id', '9080545'), ('starttime', '3/31/2016 23:30'), ('stoptime', '3/31/2016 23:46'), ('bikeid', '2295'), ('tripduration', '926'), ('from\_station\_id', '156'), ('from\_station\_name', 'Clark St \& Wellington Ave'), ('to\_station\_id', '166'), ('to\_station\_name', 'Ashland Ave \& Wrightwood Ave'), ('usertype', 'Subscriber'), ('gender', 'Male'), ('birthyear', '1990')])
...
below to address each of the cleaning tasks described above.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                 
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                 
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                 \PY{n}{duration} \PY{o}{=} \PY{n}{duration} \PY{o}{*} \PY{l+m+mf}{0.001}
                 
             \PY{n}{duration} \PY{o}{=} \PY{n}{duration}\PY{o}{/}\PY{l+m+mi}{60}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{original\PYZus{}string} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                 \PY{n}{dateobject} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{original\PYZus{}string}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{original\PYZus{}string} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                 \PY{n}{dateobject} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{original\PYZus{}string}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{original\PYZus{}string} \PY{o}{=} \PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                 \PY{n}{dateobject} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{original\PYZus{}string}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 
             \PY{n}{month} \PY{o}{=} \PY{n}{dateobject}\PY{o}{.}\PY{n}{month}
             \PY{n}{hour} \PY{o}{=} \PY{n}{dateobject}\PY{o}{.}\PY{n}{hour}
             \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{dateobject}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
...
be consistent with the example file.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{k}{def} \PY{n+nf}{condense\PYZus{}data}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{n}{out\PYZus{}file}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}
                     ...
                     \PY{n}{month}\PY{p}{,} \PY{n}{hour}\PY{p}{,} \PY{n}{dayofweek} \PY{o}{=} \PY{n}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{row}\PY{p}{,} \PY{n}{city}\PY{p}{)}
                     ...
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{duration}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{month}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{hour}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{dayofweek}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{n}{out\PYZus{}colnames}\PY{p}{[}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{n}{user\PYZus{}type}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
...
City: Washington
OrderedDict([('duration', '7.123116666666666'), ('month', '3'), ('hour', '22'), ('day\_of\_week', 'Thursday'), ('user\_type', 'Subscriber')])

City: Chicago
OrderedDict([('duration', '15.433333333333334'), ('month', '3'), ('hour', '23'), ('day\_of\_week', 'Thursday'), ('user\_type', 'Subscriber')])

City: NYC
OrderedDict([('duration', '13.983333333333333'), ('month', '1'), ('hour', '0'), ('day\_of\_week', 'Friday'), ('user\_type', 'Customer')])
...
\textbf{Answer}: New York City has the highest number of trips. NYC has
the highest proportion of trips made by subscribers. Chicago has the
proportion of trips made by short-term customers.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{subscriber\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}subscribers} \PY{o}{/} \PY{n}{n\PYZus{}total}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
                 \PY{n}{customer\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}customers} \PY{o}{/} \PY{n}{n\PYZus{}total}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
                 
                 \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                 \PY{k}{return}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{,} \PY{n}{subscriber\PYZus{}proportion}\PY{p}{,} \PY{n}{customer\PYZus{}proportion}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} the function on the cleaned data files you created from Question 3.      \PYZsh{}\PYZsh{}}
         \PY{n}{files} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         
         \PY{k}{for} \PY{n}{file} \PY{o+ow}{in} \PY{n}{files}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{file}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{:}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{,} \PY{n}{subscriber\PYZus{}proportion}\PY{p}{,} \PY{n}{customer\PYZus{}proportion} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{file}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscribers: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{n\PYZus{}subscribers}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customers: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Total: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscriber Proportion: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{subscriber\PYZus{}proportion}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customer Proportion: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{customer\PYZus{}proportion}\PY{p}{)}
...
\textbf{Answer}: Average trip length -Washington: 18.93 Ride Proportion
greater than 30 minutes is 10.84\%

Average trip length -Chicago: 16.56 Ride Proportion greater than 30
minutes is 8.33\%

Average trip length -NYC: 15.81 Ride Proportion greater than 30 minutes
is 7.3\%

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k}{def} \PY{n+nf}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{n}{trip\PYZus{}length} \PY{o}{=} \PY{l+m+mf}{0.0}
             \PY{n}{trip\PYZus{}counter} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{rides\PYZus{}duration\PYZus{}counter} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{k}{if}\PY{p}{(}\PY{n}{duration} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{)}\PY{p}{:}
                         \PY{n}{rides\PYZus{}duration\PYZus{}counter} \PY{o}{=} \PY{n}{rides\PYZus{}duration\PYZus{}counter} \PY{o}{+}\PY{l+m+mi}{1}
                         
                     \PY{n}{trip\PYZus{}length} \PY{o}{=} \PY{n}{trip\PYZus{}length} \PY{o}{+} \PY{n}{duration}
                     \PY{n}{trip\PYZus{}counter} \PY{o}{=} \PY{n}{trip\PYZus{}counter} \PY{o}{+} \PY{l+m+mi}{1}
             \PY{n}{rides\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{rides\PYZus{}duration\PYZus{}counter}\PY{o}{/}\PY{n}{trip\PYZus{}counter}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}
             \PY{k}{return} \PY{n}{rides\PYZus{}proportion}\PY{p}{,} \PY{n}{trip\PYZus{}length}\PY{o}{/}\PY{n}{trip\PYZus{}counter}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{for} \PY{n}{file} \PY{o+ow}{in} \PY{n}{files}\PY{p}{:}
                 \PY{n}{rides\PYZus{}proportion}\PY{p}{,} \PY{n}{average\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{avg\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{file}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{n}{file}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Ride Proportion greater than 30 minutes is }\PY{l+s+si}{\PYZob{}0\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n}{rides\PYZus{}proportion}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{)}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Customer take Longer ride for NYC
...
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{evaluate\PYZus{}user\PYZus{}ride}\PY{p}{(}\PY{n}{filename}\PY{p}{,}\PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{n}{customer\PYZus{}duration} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{customer\PYZus{}counter} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{subscriber\PYZus{}duration}\PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{subscriber\PYZus{}counter} \PY{o}{=} \PY{l+m+mi}{0}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{customer\PYZus{}duration} \PY{o}{=} \PY{n}{customer\PYZus{}duration} \PY{o}{+} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                         \PY{n}{customer\PYZus{}counter} \PY{o}{=} \PY{n}{customer\PYZus{}counter} \PY{o}{+} \PY{l+m+mi}{1}
         
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{subsrciber\PYZus{}duration} \PY{o}{=} \PY{n}{subscriber\PYZus{}duration} \PY{o}{+} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}   
                         \PY{n}{subscriber\PYZus{}counter} \PY{o}{=} \PY{n}{subscriber\PYZus{}counter} \PY{o}{+} \PY{l+m+mi}{1}
                 
                 \PY{n}{customer\PYZus{}avg\PYZus{}duration} \PY{o}{=} \PY{n}{customer\PYZus{}duration}\PY{o}{/}\PY{n}{customer\PYZus{}counter}
                 \PY{n}{subscriber\PYZus{}avg\PYZus{}duration} \PY{o}{=} \PY{n}{subsrciber\PYZus{}duration}\PY{o}{/}\PY{n}{subscriber\PYZus{}counter}
                 
                 \PY{k}{if} \PY{n}{customer\PYZus{}avg\PYZus{}duration} \PY{o}{\PYZgt{}} \PY{n}{subscriber\PYZus{}avg\PYZus{}duration}\PY{p}{:}
                     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customer take Longer ride for }\PY{l+s+si}{\PYZob{}0\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{)}\PY{p}{)}
                 \PY{k}{else}\PY{p}{:}
                     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscriber take Longer ride for }\PY{l+s+si}{\PYZob{}0\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{city}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{n}{file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         
         
         \PY{n}{evaluate\PYZus{}user\PYZus{}ride}\PY{p}{(}\PY{n}{file}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} and then use pyplot functions to generate a histogram of trip times.     \PYZsh{}\PYZsh{}}
         
         \PY{k}{def} \PY{n+nf}{generate\PYZus{}histogram}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{n}{hist\PYZus{}data} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if}\PY{p}{(}\PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
                         \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                         \PY{n}{hist\PYZus{}data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{round}\PY{p}{(}\PY{n}{duration}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
             
             \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{hist\PYZus{}data}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distribution of Newyork city trip time}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Duration(m)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{generate\PYZus{}histogram}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: For subscribers the peak duration is 10-15 minutes and
for customers peak duration is 25-30 minutes

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         \PY{k+kn}{import} \PY{n+nn}{pylab}
         \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         \PY{k+kn}{from} \PY{n+nn}{pylab} \PY{k}{import} \PY{n}{xticks}
         
         \PY{k}{def} \PY{n+nf}{generate\PYZus{}histogram\PYZus{}for\PYZus{}subscribers}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             
             \PY{n}{hist\PYZus{}data} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{n}{counter} \PY{o}{=} \PY{l+m+mi}{0}
             
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{fin}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{fin}\PY{p}{)}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{duration} \PY{o}{=}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                         \PY{n}{hist\PYZus{}data}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{duration}\PY{p}{)}
                         \PY{n}{counter} \PY{o}{=} \PY{n}{counter} \PY{o}{+} \PY{l+m+mi}{1}
                   
             \PY{n}{bins} \PY{o}{=}  \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{hist\PYZus{}data}\PY{p}{,} \PY{n}{bins}\PY{p}{)}
             \PY{n}{labels} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{15}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{20}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{30}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{35}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{40}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{45}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{50}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{55,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{60}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{65}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{70}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{75}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{bins} \PY{p}{,} \PY{n}{labels}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distribution of trip duration for subscribers in Newyork}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Duration(m)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{n}{file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{generate\PYZus{}histogram\PYZus{}for\PYZus{}subscribers}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k}{def} \PY{n+nf}{generate\PYZus{}histogram\PYZus{}for\PYZus{}customers}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{labels} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{5}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{15}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{20}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{30}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{35}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{40}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{45}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{50}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{55,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{60}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{65}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{70}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{75}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{bins} \PY{p}{,} \PY{n}{labels}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Distribution of trip duration for customers in Newyork}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Duration(m)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{n}{file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{generate\PYZus{}histogram\PYZus{}for\PYZus{}customers}\PY{p}{(}\PY{n}{file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: The ridership differ by season and city. Winter in the
three cities has the lowest ridership. Autumn has the highest ridership.
For Newyork, the ratio of Subscriber trips to Customer trips is highest
in winter.

Washington: Maximum Subscribers in Season:Summer which is 16160 Maximum
Customers in Season:Summer which is 5699 Maximum Users in Season:Summer
which is 21859

Newyork: Maximum Subscribers in Season:Autumn which is 78554 Maximum
Customers in Season:Summer which is 11525 Maximum Users in Season:Autumn
which is 88366

Chicago: Maximum Subscribers in Season:Summer which is 21198 Maximum
Customers in Season:Summer which is 8692 Maximum Users in Season:Summer
which is 29890

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{seasonal\PYZus{}based\PYZus{}trips\PYZus{}computation}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 
                 \PY{n}{season\PYZus{}winter} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{12}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
                 \PY{n}{season\PYZus{}spring} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}
                 \PY{n}{season\PYZus{}summer} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}
                 \PY{n}{season\PYZus{}autumn} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{9}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{11}\PY{p}{)}
                 
                 \PY{n}{num\PYZus{}subscriber\PYZus{}winter} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}subscriber\PYZus{}spring} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}subscriber\PYZus{}summer} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{o}{=} \PY{l+m+mi}{0}
                     
                 \PY{n}{num\PYZus{}customer\PYZus{}winter} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}customer\PYZus{}spring} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}customer\PYZus{}summer} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{num\PYZus{}customer\PYZus{}autumn} \PY{o}{=} \PY{l+m+mi}{0}
         
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{k}{if} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}winter}\PY{p}{:}
                             \PY{n}{num\PYZus{}subscriber\PYZus{}winter} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}winter} \PY{o}{+} \PY{l+m+mi}{1}
                             
                         \PY{k}{elif} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}spring}\PY{p}{:}
                             \PY{n}{num\PYZus{}subscriber\PYZus{}spring} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}spring} \PY{o}{+} \PY{l+m+mi}{1}
                         
                         \PY{k}{elif} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}summer}\PY{p}{:}
                             \PY{n}{num\PYZus{}subscriber\PYZus{}summer} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}summer} \PY{o}{+} \PY{l+m+mi}{1}
                         
                         \PY{k}{else}\PY{p}{:}
                             \PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{o}{+} \PY{l+m+mi}{1}
                     
                     \PY{k}{else}\PY{p}{:}
                         \PY{k}{if} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}winter}\PY{p}{:}
                             \PY{n}{num\PYZus{}customer\PYZus{}winter} \PY{o}{=} \PY{n}{num\PYZus{}customer\PYZus{}winter} \PY{o}{+} \PY{l+m+mi}{1}
                             
                         \PY{k}{elif} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}spring}\PY{p}{:}
                             \PY{n}{num\PYZus{}customer\PYZus{}spring} \PY{o}{=} \PY{n}{num\PYZus{}customer\PYZus{}spring} \PY{o}{+} \PY{l+m+mi}{1}
                         
                         \PY{k}{elif} \PY{n+nb}{int}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o+ow}{in} \PY{n}{season\PYZus{}summer}\PY{p}{:}
                             \PY{n}{num\PYZus{}customer\PYZus{}summer} \PY{o}{=} \PY{n}{num\PYZus{}customer\PYZus{}summer} \PY{o}{+} \PY{l+m+mi}{1}
                         
                         \PY{k}{else}\PY{p}{:}
                             \PY{n}{num\PYZus{}customer\PYZus{}autumn} \PY{o}{=} \PY{n}{num\PYZus{}customer\PYZus{}autumn} \PY{o}{+} \PY{l+m+mi}{1}
                             
                 \PY{n}{num\PYZus{}users\PYZus{}winter} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}winter} \PY{o}{+} \PY{n}{num\PYZus{}customer\PYZus{}winter}
                 \PY{n}{num\PYZus{}users\PYZus{}spring} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}spring} \PY{o}{+} \PY{n}{num\PYZus{}customer\PYZus{}spring}
                 \PY{n}{num\PYZus{}users\PYZus{}summer} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}summer} \PY{o}{+} \PY{n}{num\PYZus{}customer\PYZus{}summer}
                 \PY{n}{num\PYZus{}users\PYZus{}autumn} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{o}{+} \PY{n}{num\PYZus{}customer\PYZus{}autumn}
                 
                 \PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}winter} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}winter} \PY{o}{/} \PY{n}{num\PYZus{}customer\PYZus{}winter}
                 \PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}spring} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}spring} \PY{o}{/} \PY{n}{num\PYZus{}customer\PYZus{}spring}
                 \PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}summer} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}summer} \PY{o}{/} \PY{n}{num\PYZus{}customer\PYZus{}summer}
                 \PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}autumn} \PY{o}{=} \PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{o}{/} \PY{n}{num\PYZus{}customer\PYZus{}autumn}
                 
                 \PY{n}{season\PYZus{}to\PYZus{}subscriber} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Winter}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}subscriber\PYZus{}winter}\PY{p}{,}
                                          \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Spring}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}subscriber\PYZus{}spring}\PY{p}{,} 
                                          \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Summer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}subscriber\PYZus{}summer}\PY{p}{,}
                                          \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Autumn}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}subscriber\PYZus{}autumn} \PY{p}{\PYZcb{}}
                 
                 \PY{n}{season\PYZus{}to\PYZus{}customer} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Winter}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}customer\PYZus{}winter}\PY{p}{,}
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Spring}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}customer\PYZus{}spring}\PY{p}{,} 
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Summer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}customer\PYZus{}summer}\PY{p}{,}
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Autumn}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}customer\PYZus{}autumn} \PY{p}{\PYZcb{}}
                 
                 \PY{n}{season\PYZus{}to\PYZus{}user\PYZus{}proportion} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Winter}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}winter}\PY{p}{,}
                                             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Spring}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}spring}\PY{p}{,} 
                                             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Summer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}summer}\PY{p}{,}
                                             \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Autumn}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{subscribers\PYZus{}to\PYZus{}customer\PYZus{}proportion\PYZus{}autumn} \PY{p}{\PYZcb{}}
                 
                 \PY{n}{season\PYZus{}to\PYZus{}users} \PY{o}{=}  \PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Winter}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}users\PYZus{}winter}\PY{p}{,}
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Spring}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}users\PYZus{}spring}\PY{p}{,} 
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Summer}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}users\PYZus{}summer}\PY{p}{,}
                                         \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Autumn}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}\PY{n}{num\PYZus{}users\PYZus{}autumn} \PY{p}{\PYZcb{}}
                 
                 
                 \PY{k}{return} \PY{n}{season\PYZus{}to\PYZus{}subscriber}\PY{p}{,} \PY{n}{season\PYZus{}to\PYZus{}customer}\PY{p}{,} \PY{n}{season\PYZus{}to\PYZus{}user\PYZus{}proportion}\PY{p}{,} \PY{n}{season\PYZus{}to\PYZus{}users}
...
{\color{incolor}In [{\color{incolor}48}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
         ...
         \PY{n}{file\PYZus{}washington} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{file\PYZus{}nyc}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{file\PYZus{}chicago}\PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         
         \PY{n}{washington\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}proportion}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}users} \PY{o}{=} \PY{n}{seasonal\PYZus{}based\PYZus{}trips\PYZus{}computation}\PY{p}{(}\PY{n}{file\PYZus{}washington}\PY{p}{)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{WASHINGTON:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}washinton} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{washington\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{washington\PYZus{}seasonal\PYZus{}subcriber}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Subscribers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}washinton}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}washinton}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}washinton} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{washington\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{washington\PYZus{}seasonal\PYZus{}cutomer}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Customers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}washinton}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}washinton}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}washinton} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{washington\PYZus{}seasonal\PYZus{}users}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{washington\PYZus{}seasonal\PYZus{}users}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Users in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}washinton}\PY{p}{,} \PY{n}{washington\PYZus{}seasonal\PYZus{}users}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}washinton}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         
         \PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}proportion}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}users} \PY{o}{=} \PY{n}{seasonal\PYZus{}based\PYZus{}trips\PYZus{}computation}\PY{p}{(}\PY{n}{file\PYZus{}nyc}\PY{p}{)}
         
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{NYC:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}nyc} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Subscribers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}nyc}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}nyc}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}nyc} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Customers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}nyc}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}nyc}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}nyc} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{nyc\PYZus{}seasonal\PYZus{}users}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{nyc\PYZus{}seasonal\PYZus{}users}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Users in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}nyc}\PY{p}{,} \PY{n}{nyc\PYZus{}seasonal\PYZus{}users}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}nyc}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{chi\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}proportion}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}users} \PY{o}{=} \PY{n}{seasonal\PYZus{}based\PYZus{}trips\PYZus{}computation}\PY{p}{(}\PY{n}{file\PYZus{}chicago}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Chicago:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}chi} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{chi\PYZus{}seasonal\PYZus{}subcriber}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Subscribers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}chi}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}subscribers\PYZus{}chi}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}chi} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{chi\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{chi\PYZus{}seasonal\PYZus{}cutomer}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Customers in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}chi}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}customers\PYZus{}chi}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}chi} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{chi\PYZus{}seasonal\PYZus{}users}\PY{p}{,} \PY{n}{key}\PY{o}{=} \PY{n}{chi\PYZus{}seasonal\PYZus{}users}\PY{o}{.}\PY{n}{get}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Maximum Users in Season:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ which is }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}chi}\PY{p}{,} \PY{n}{chi\PYZus{}seasonal\PYZus{}users}\PY{p}{[}\PY{n}{key\PYZus{}season\PYZus{}users\PYZus{}chi}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{}Histogram for subscriber and customer}
         \PY{n}{x1} \PY{o}{=} \PY{p}{[}\PY{n}{k} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{p}{]}
         \PY{n}{y1} \PY{o}{=} \PY{p}{[}\PY{n}{v} \PY{k}{for} \PY{n}{v} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}subcriber}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{]}
         
         
         \PY{n}{x2} \PY{o}{=} \PY{p}{[}\PY{n}{k} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{p}{]}
         \PY{n}{y2} \PY{o}{=} \PY{p}{[}\PY{n}{v} \PY{k}{for} \PY{n}{v} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}cutomer}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{]}
         
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{x1}\PY{p}{,} \PY{n}{y1}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}} \PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{x2}\PY{p}{,} \PY{n}{y2}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Newyork Subscribers and Customers Bar Chart}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Seasons}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of Trips}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         
         
         \PY{n}{x3} \PY{o}{=} \PY{p}{[}\PY{n}{k} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}proportion}\PY{p}{]}
         \PY{n}{y3} \PY{o}{=} \PY{p}{[}\PY{n}{v} \PY{k}{for} \PY{n}{v} \PY{o+ow}{in} \PY{n}{nyc\PYZus{}seasonal\PYZus{}proportion}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{]}
         
         \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{x3}\PY{p}{,} \PY{n}{y3}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Proportion}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Ration of Subscribers trips to Customer trips}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
**Answer*: I would like to apply the techniques of data science to know
how employee office timings affects productivity. I can get the data
about the time employees come into the office and classify them based on
timings. Now, I can investigate the tasks they work on and how efficient
they are. This way, I would able to know how productive an employee is
for a company.
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{k+kn}{from} \PY{n+nn}{subprocess} \PY{k}{import} \PY{n}{call}
